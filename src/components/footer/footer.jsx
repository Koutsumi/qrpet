  ...
  return (
    <footer>
      <section className="bg-principal w-full flex flex-col items-center justify-center text-white text-center text-[1.2em] pb-2">
        ...
        <h4 className="w-full my-2">Desenvolvido por</h4>
        <div className="w-[90%] lg:flex flex-row">
          <div className="w-full my-2  ">
            <h5> Fernanda </h5>{" "}
            <a
              href="https://www.linkedin.com/in/fernanda-matuda-baccarini-455b39171/"
              target="_blank"
            >
              Linkedin{" "}
            </a>
            |
            <a href="https://github.com/Koutsumi" target="_blank">
              {" "}
              Git Hub
            </a>
          </div>
          <div className="w-full my-2">
            <h5>Flavio</h5>{" "}
            <a
              href="https://www.linkedin.com/in/flavio-brancalhao-659574169/"
              target="_blank"
            >
              Linkedin{" "}
            </a>
